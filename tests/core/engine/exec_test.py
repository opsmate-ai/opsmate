...
class TestExec(BaseTestCase):
    ...
    def test_exec_react_task_with_non_react_output(self, client):
        task = Task(
    ...
    def test_exec_react_task_with_no_react_context(self, client):
        task = Task(
            metadata=Metadata(name="test-task"),
            spec=TaskSpec(
                contexts=[os_ctx],
    ...
    def test_exec_react_task_with_max_depth_0(self, client):
        task = Task(
            metadata=Metadata(name="test-task"),
            spec=TaskSpec(
    ...
    def test_exec_react_task_with_cli_ctx(self, client):
        task = Task(
            metadata=Metadata(name="test-task"),
            spec=TaskSpec(
    ...
    def test_exec_react_task_with_resolved_answer(self, client):
    ...
    def test_exec_react_task_make_sure_not_lazy(self, client):
        task = Task(
            metadata=Metadata(name="test-task"),
            spec=TaskSpec(
                contexts=[cli_ctx, react_ctx],
    ...
    def test_exec_react_task_with_knowledge_base_query(self, client):
        task = Task(
            metadata=Metadata(name="test-task"),
            spec=TaskSpec(
                contexts=[cli_ctx, react_ctx],
