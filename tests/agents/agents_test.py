...
def test_get_supervisor_agent_list_context():
...
def test_supervisor_agent_with_extra_context_as_string():
    agents = [k8s_agent, cli_agent]
    agents = [agent() for agent in agents]
...
def test_supervisor_agent_with_extra_context_as_list():
    agents = [k8s_agent, cli_agent]
    agents = [agent() for agent in agents]
...
def test_supervisor_agent_with_extra_context_has_react_configures():
    agents = [k8s_agent, cli_agent]
    agents = [agent() for agent in agents]
    ...
    react_context = [ctx for ctx in supervisor_contexts if ctx.metadata.name == "react"]
...
def test_supervisor_agent_with_extra_context_has_the_correct_subagents():
    agents = [k8s_agent, cli_agent]
    agents = [agent() for agent in agents]
